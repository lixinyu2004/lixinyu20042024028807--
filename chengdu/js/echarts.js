    ...
    function echarts_1() {
        ...
        option = {
            ...
            legend: { //图例组件，颜色和名字
                ...
                itemHeight: 10,
                icon: 'rect',
                data: ['兼职刷单', '投资理财', '冒充客服','网络贷款','冒充领导','网络招嫖'],
                textStyle: {
                    color: [],
                    fontStyle: 'normal',
                    fontFamily: '微软雅黑',
...
option = {
  ...
  /***  title: {
    ...
    function echarts_5() {
        ...
        var xData = function() {
            var data = ['投资理财','冒充领导','网络贷款','冒充客服','简直刷单'];

            return data;
        }();

        var data = [405935,163000,89497,74735,60838]
    ...
    function echarts_6() {
        ...
        option = {
            ...
            xAxis: [{
                type: 'category',
                show: false,
                data: ['仿冒身份欺诈', '购物类欺诈', '爱心传递贴', '手机窃听诈骗', '高校补录诈骗'],
                axisLabel: {
                    textStyle: {
                        color: '#b6b5ab'
                    }
