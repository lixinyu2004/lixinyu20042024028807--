...
var data = [11,2,5,2,1,1,1,1,8,3,7,9]
var titlename = ['案件', '案损(亿元)', '虚假投资理财', '冒充老板', '网络博彩', '刷单返利', '冒充客服', '冒充朋友', '女性', '男性', '40岁至49岁', '企业就职'];
option = {
	grid: {
        left: '0',
		top:'0',
   ...
   data: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月']
    ...
    series: [
       ...
       smooth: true,
        ...
        data: [350, 621, 150, 441, 311, 90, 322,112, 66, 89, 30, 157, 295, 131]
          ...
          legend: {
           orient: 'vertical',
            ...
            textStyle:{
              ...
              top:'20%',
          right:30,
            data:['虚假投资','冒充老板','网络博彩','刷单返利','冒充客服','冒充朋友']
        },
